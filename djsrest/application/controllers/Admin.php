...
class Admin extends CI_Controller {
	...
	public function user_management()
	{
		...
		$crud->columns('USER_ID', 'FIRST_NM', 'LAST_NM', 'STREET_NUM', 'STREET_NM','ZIP_CD', 'EMAIL_ADDR', 'USER_TYPE_CD');
  		...
  		$crud->callback_add_field('STATE_CD',function () {
			$output = states_dropdown('state_dropdown', '');
			return $output;
		});			
	...
	public function credit_card_management() {
		...
		$crud->required_fields('CC_TYPE', 'CC_NUM', 'SEC_CD', 'EXP_DT', 'STREET_NUM', 'ZIP_CD');
		
		$crud->columns('CC_ID','USER_ID', 'CC_TYPE', 'CC_NUM', 'SEC_CD', 'EXP_DT', 'STREET_NUM', 'STREET_NM', 'STATE_CD', 'ZIP_CD');
		
		$crud->field_type('EXP_DT', 'date');
		$crud->field_type('STATE_CD', 'dropdown');
		$crud->callback_add_field('STATE_CD',function () {
			$output = states_dropdown('state_dropdown', set_value('state'));
			return $output;
		});
		
		$crud
		->display_as('CC_ID', 'Id')
		->display_as('USER_ID', 'User Id')
		...
		$crud->add_fields('CC_TYPE', 'CC_NUM', 'SEC_CD', 'EXP_DT', 'STREET_NUM', 'STREET_NM', 'STATE_CD', 'ZIP_CD');
